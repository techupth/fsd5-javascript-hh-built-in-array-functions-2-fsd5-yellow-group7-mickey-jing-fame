...
const totalPaidByLocaltion = {};

for (let bill of bills) {
  if (!listOfLocation.includes(bill.location)) {
    listOfLocation.push(bill.location);
    totalPaidByLocaltion[`${bill.location}`] = bill.total;
  } else {
    totalPaidByLocaltion[`${bill.location}`] += bill.total;
  }
}
console.log(listOfLocation);
console.log(totalPaidByLocaltion);
